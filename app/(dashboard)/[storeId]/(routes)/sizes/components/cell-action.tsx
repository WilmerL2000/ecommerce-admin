...
export default function CellAction({ data }: CellActionProps) {
  ...
  /**
   * The function `onConfirm` is an asynchronous function that deletes a size using an API call,
   ...
   * @param {string} id - The `id` parameter is a string that represents the Size ID that needs to
